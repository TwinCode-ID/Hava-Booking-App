...
const Hero = () => {
  ...
  if (loading)
    return <div className='text-center py-20'>Loading studios...</div>;
  if (error)
            ...
            <div className='w-[340px] h-full bg-white rounded-[40px] shadow-xl overflow-hidden hover:scale-[1.02] transition-transform duration-300 ease-in-out flex flex-col'>
              ...
              <div className='p-8 flex-1 flex flex-col'>
                ...
                <div className='grid grid-cols-2 gap-2 mx-auto w-full justify-center'>
                  ...
                  <button className='w-full bg-black text-white text-lg font-medium py-4 rounded-3xl hover:bg-gray-800 transition-colors shadow-lg'>
                    Show more
                  </button>
                </div>
              </div>
