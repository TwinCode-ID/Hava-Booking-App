...
import {
  ...
  ArrowUpDown,
  CheckCircle2,
  XCircle, // Updated Icon
  AlertTriangle, // Updated Icon
  Clock, // Updated Icon
  Eye,
} from "lucide-react";
      ...
      <div className='flex flex-col md:flex-row justify-between items-center mb-6 gap-4 relative z-20'>
        ...
        <div className='flex items-center justify-end gap-3 w-full md:w-auto'>
          ...
          <button
            ...
            className={`w-11 h-11 rounded-xl flex items-center justify-center transition-colors shadow-sm border border-transparent shrink-0 ${
              isFilterOpen
      ...
      <AnimatePresence>
        {selectedPurchase && (
          <ReviewModal
            ...
            // Update onApprove to receive data
