...
const PurchaseRow = ({ purchase, getStatusColor, onReview }) => {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
      className='bg-white p-5 rounded-2xl border border-stone-100 shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row items-center justify-between gap-4'>
      {/* Left: User & Pack Info */}
      <div className='flex items-center gap-4 w-full md:w-auto'>
        <div className='w-12 h-12 bg-stone-100 rounded-full flex items-center justify-center text-stone-400 shrink-0'>
        ...
        <div>
          ...
          <p className='text-sm text-stone-500 flex items-center gap-2'>
            <span className='bg-stone-100 px-2 py-0.5 rounded text-xs text-stone-600 font-medium font-mono'>
      ...
      {/* Middle: Details */}
      <div className='flex flex-wrap gap-6 text-sm text-stone-600 w-full md:w-auto'>
        ...
        <div className='font-mono font-bold text-stone-900 flex items-center bg-stone-50 px-3 py-1.5 rounded-lg border border-stone-200'>
