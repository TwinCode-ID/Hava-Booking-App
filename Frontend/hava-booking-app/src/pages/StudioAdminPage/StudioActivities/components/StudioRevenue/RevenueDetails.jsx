    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm'>
      <motion.div
        ...
        <div className='p-6 space-y-6'>
          ...
          <div className='grid grid-cols-2 gap-4'>
            <div className='p-3 bg-stone-50 rounded-xl border border-stone-100'>
              <span className='text-xs text-stone-500 flex items-center gap-1 mb-1'>
        ...
        <div className='p-4 border-t border-stone-100 bg-stone-50 flex justify-end'>
          <button
            onClick={onClose}
            className='px-6 py-2 bg-white border border-stone-200 text-stone-700 font-bold rounded-xl shadow-sm hover:bg-stone-50'>
            Close
          </button>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        <div className='overflow-y-auto flex-1 p-0'>
          {clients.map((client, idx) => (
            <div
              key={idx}
              className='flex items-center gap-3 p-4 border-b border-stone-50 hover:bg-stone-50 transition-colors'>
              <div className='w-10 h-10 rounded-full bg-stone-200 text-stone-800 flex items-center justify-center font-bold text-sm'>
    ...
    <div className='p-6 md:p-10 bg-canvas min-h-screen relative'>
          ...
          <div className='relative'>
            ...
            {isExportOpen && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: 5 }}
                className='absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-stone-100 overflow-hidden z-20'>
                <button
                  onClick={exportCSV}
                  className='w-full text-left px-4 py-3 text-sm text-stone-700 hover:bg-stone-50 flex items-center gap-2'>
                  <FileSpreadsheet className='w-4 h-4 text-green-600' />{" "}
                  Download CSV
                </button>
                <button
                  onClick={handlePreview}
                  className='w-full text-left px-4 py-3 text-sm text-stone-700 hover:bg-stone-50 flex items-center gap-2 border-t border-stone-50'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
        ...
        <div className='bg-white p-6 rounded-2xl shadow-sm border border-stone-100 flex flex-col justify-center'>
          ...
          <motion.div
            ...
            className='flex items-center gap-4 cursor-pointer hover:bg-stone-50 p-2 -mx-2 rounded-lg transition-colors'>
              ...
              <motion.div
                ...
                className={`cursor-pointer rounded-lg p-2 transition-colors border ${
                  methodFilter === item.name
                    ? "bg-stone-50 border-stone-300 ring-1 ring-stone-500"
                ...
                <p className='text-xs text-right text-stone-400 mt-1'>
      ...
      <div className='bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden'>
        <div className='px-6 py-4 border-b border-stone-100 flex justify-between items-center bg-stone-50/50'>
          <h3 className='font-bold text-stone-800'>Transaction History</h3>
          <span className='text-xs font-medium px-2 py-1 bg-stone-200 rounded-md text-stone-600'>
        ...
        <div className='overflow-x-auto'>
          <table className='w-full text-left border-collapse'>
            <thead>
              <tr className='border-b border-stone-100 text-xs uppercase tracking-wider text-stone-500 bg-stone-50/30'>
                  ...
                  tableData.map((trx, index) => (
                    <motion.tr
                      ...
                      <td className='px-6 py-4 text-sm text-stone-600'>
                        <span className='px-2 py-1 bg-stone-100 text-stone-800 rounded-md text-xs font-medium border border-stone-200'>
                      ...
                      <td className='px-6 py-4 text-right'>
                        ...
                        <div className='text-xs text-stone-800 font-medium bg-stone-100 inline-block px-2 rounded-full mt-1'>
                          Confirmed
                        </div>
                      </td>
                    </motion.tr>
