            ...
            <form onSubmit={handleUpdateProfile} className='p-8 space-y-6'>
              ...
              <div className='pt-4 flex justify-end'>
                <button
                  ...
                  className='px-6 py-2.5 bg-stone-900 text-white rounded-xl font-bold text-sm shadow-lg shadow-stone-900/20 hover:bg-stone-800 hover:-translate-y-0.5 transition-all flex items-center gap-2 disabled:opacity-70 disabled:translate-y-0 disabled:cursor-not-allowed'>
                  {isLoadingProfile ? (
            ...
            <form onSubmit={handleUpdatePassword} className='p-8 space-y-6'>
              ...
              <div className='pt-2 flex justify-end'>
                <button
                  ...
                  className='px-6 py-2.5 bg-stone-900 text-white rounded-xl font-bold text-sm shadow-lg shadow-stone-900/20 hover:bg-stone-800 hover:-translate-y-0.5 transition-all flex items-center gap-2 disabled:opacity-50 disabled:translate-y-0 disabled:cursor-not-allowed'>
                  {isLoadingPassword ? (
                    <Loader2 className='w-4 h-4 animate-spin' />
                  ) : (
