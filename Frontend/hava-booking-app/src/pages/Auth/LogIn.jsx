            ...
            <motion.div
              ...
              <div className='flex flex-col gap-3'>
                ...
                <div
                  ...
                  className='w-full flex justify-center h-13'></div>
                ...
                <button
                  ...
                  className='w-full bg-black text-white px-6 h-10 rounded border border-black font-medium hover:bg-gray-900 transition-all flex items-center justify-center gap-3 disabled:opacity-50'>
