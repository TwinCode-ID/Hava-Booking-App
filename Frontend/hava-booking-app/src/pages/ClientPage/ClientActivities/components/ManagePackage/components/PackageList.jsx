        ...
        <div className='space-y-3 mt-3'>
          {uniqueStudioLocation.map((type) => (
            <label
              ...
              />
              <span
                className={`text-[15px] ${selectedStudioLocations.includes(type) ? "text-stone-900 font-bold" : "text-stone-600 font-medium"}`}>
                {type}
              </span>
            </label>
          ))}
          ...
          {uniqueInstructorTypes.map((type) => {
            ...
            return (
              <label
                ...
                />
                <span
                  className={`text-[15px] ${isSelected ? "text-stone-900 font-bold" : "text-stone-600 font-medium"}`}>
                  {type}
                </span>
              </label>
            );
      ...
      <div className='space-y-4 pb-4 md:pb-0'>
        ...
        <div className='flex items-center gap-3 mt-3'>
          <input
            ...
            className='w-full px-4 py-3 md:py-2.5 bg-white border border-stone-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-stone-500 focus:border-stone-500'
          />
            ...
            <motion.div
              ...
              {paymentLoading && (
                <div className='absolute inset-0 z-50 flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm'>
                  ...
                  <p className='text-stone-600 font-bold mt-4'>
                    Processing your payment...
                  </p>
                </div>
              )}

              <div className='flex justify-between items-center px-6 md:px-8 py-4 md:py-6 border-b border-stone-100 bg-white z-10 shrink-0'>
                <h2 className='text-lg md:text-[20px] font-semibold text-stone-900 flex items-center gap-2 md:gap-3'>
                  <Zap className='w-5 h-5 md:w-[24px] md:h-[24px] text-stone-700' />{" "}
              ...
              <div className='p-4 md:p-8 overflow-y-auto bg-stone-50 flex flex-col gap-4 md:gap-6 custom-scrollbar overscroll-contain'>
                ...
                <div className='bg-white p-5 md:p-6 rounded-2xl md:rounded-3xl border border-stone-100 shadow-sm'>
                  <h4 className='text-xs md:text-[13px] font-bold text-stone-900 mb-3 uppercase tracking-wider flex items-center gap-2'>
                  ...
                  {promoMessage && (
                    <motion.p
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      className={`mt-3 text-[12px] md:text-[13px] font-bold flex items-center gap-1.5 ${promoMessage.type === "success" ? "text-stone-700" : "text-red-500"}`}>
  ...
  return (
    <div className='flex flex-col h-full space-y-6 md:space-y-8'>
      ...
      {!isOwner ? (
        ...
        <div className='bg-white border border-stone-200 rounded-2xl md:rounded-3xl p-6 md:p-8 text-center shadow-sm'>
        ...
        <div className='space-y-6 md:space-y-8'>
          <div>
            ...
            <div className='grid grid-cols-2 gap-3 md:gap-4'>
              <button
                ...
                disabled={loading}
                className='py-3.5 md:py-4 bg-white border border-stone-200 rounded-xl hover:border-stone-500 hover:bg-stone-100 hover:text-stone-800 transition-all font-bold text-sm md:text-[15px] text-stone-700 shadow-sm active:scale-95'>
                1 Week
              </button>
              <button
          ...
          <div className='pt-2 border-t border-stone-200'>
            <h4 className='text-sm md:text-[15px] font-bold text-stone-900 mb-3 md:mb-4 mt-2'>
            ...
            <div className='flex flex-col sm:flex-row gap-3 md:gap-4'>
              <input
                ...
                className='w-full sm:w-24 px-4 py-3.5 md:py-3 bg-white border border-stone-200 rounded-xl text-center text-sm md:text-[16px] font-bold focus:outline-none focus:ring-2 focus:ring-stone-500/20 shadow-sm'
              />
              <button
