...
const InlineMedicalWarning = ({ onOpenModal }) => {
  return (
    <div className='bg-white p-5 md:p-8 border border-stone-100 rounded-2xl md:rounded-3xl shadow-sm text-center relative overflow-hidden'>
      ...
      <button
        onClick={onOpenModal}
        className='relative z-10 w-full py-3.5 md:py-4 bg-stone-600 text-white text-sm md:text-base font-bold rounded-xl md:rounded-2xl hover:bg-[#0F2922] shadow-lg shadow-stone-600/20 transition-all active:scale-[0.98]'>
                      ...
                      <div className='flex flex-col sm:flex-row gap-3'>
                        ...
                        {!appliedPromo ? (
                          <button
                            ...
                            className='w-full sm:w-auto px-6 py-3.5 md:py-3 bg-stone-600 hover:bg-[#0F2922] text-white text-[14px] md:text-[15px] font-bold rounded-xl transition-colors disabled:bg-stone-300 disabled:text-stone-500 flex items-center justify-center min-w-[100px] shadow-sm active:scale-[0.98] md:active:scale-100'>
                            {promoLoading ? (
          ...
          <div className='fixed inset-0 z-[60] flex items-end justify-center lg:hidden p-0 bg-black/60 backdrop-blur-sm'>
            ...
            <motion.div
              ...
              <div className='p-4 border-t border-stone-100 bg-white shrink-0'>
                <button
                  onClick={() => setShowMobileFilters(false)}
                  className='w-full py-4 bg-stone-600 text-white font-bold rounded-xl active:scale-[0.98] transition-all shadow-md'>
                  Apply Filters
                </button>
              </div>
            </motion.div>
        ...
        <div className='space-y-6 md:space-y-8'>
          ...
          <div className='pt-6 border-t border-stone-200'>
            <button
              ...
              className='w-full py-4 bg-stone-600 text-white rounded-xl font-bold text-sm md:text-[15px] hover:bg-[#0F2922] flex justify-center items-center shadow-lg transition-all disabled:opacity-50 disabled:shadow-none active:scale-[0.98]'>
              {loading ? (
                <Loader2 className='w-5 h-5 animate-spin' />
              ) : (
