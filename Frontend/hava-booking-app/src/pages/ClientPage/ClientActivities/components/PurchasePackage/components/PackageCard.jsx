  ...
  return (
    <motion.div
      ...
      className={`relative bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 transition-all duration-300 flex flex-col h-full ${
        isBestValue
          ? "border-stone-500 ring-1 ring-stone-500/20 shadow-lg shadow-stone-600/5"
          : "border-stone-100 border shadow-sm hover:shadow-xl hover:border-stone-300"
      }`}>
      {/* "Best Value" Badge */}
      {isBestValue && (
      ...
      <div className='mb-5 md:mb-6 mt-2 md:mt-0'>
        <h3 className='text-lg md:text-xl font-bold text-stone-900 mb-1.5 md:mb-2 line-clamp-2'>
          {pkg.packageName}
        </h3>
        <p className='text-stone-500 text-xs md:text-sm line-clamp-2 min-h-[32px] md:min-h-[40px] leading-relaxed'>
      ...
      <div className='mb-6 md:mb-8 flex items-baseline flex-wrap gap-1'>
        <span className='text-2xl md:text-3xl font-bold text-stone-800 tracking-tight'>
