...
const MarketplaceModal = ({
  ...
  const filteredPackages = packages
    .filter((pkg) => {
      ...
      // Handle Combo Packages vs Regular Packages
      if (pkg.isCombo) {
  ...
  return (
    <div className='fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200'>
      <div className='bg-white w-full max-w-6xl h-[90vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-200'>
        {/* =========================================================
            HEADER (Adapts based on view)
        ========================================================= */}
        <div className='p-6 border-b border-gray-100 flex justify-between items-center bg-white shrink-0 shadow-sm z-10'>
          {!selectedPackage ? (
            <div>
            ...
            <div className='flex items-center gap-4'>
              <button
                ...
                className='p-2.5 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-full transition-colors'>
        ...
        <div className='flex-1 overflow-y-auto bg-[#F9FAFB] relative'>
          ...
          {!selectedPackage && (
            <div className='p-6'>
              {loading ? (
                <div className='h-full flex items-center justify-center flex-col gap-2 pt-20'>
            ...
            <div className='p-6 md:p-8 animate-in slide-in-from-right-8 duration-300'>
              <div className='flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto items-start'>
                ...
                <div className='w-full lg:w-[420px] xl:w-[480px] shrink-0'>
                  <div className='bg-white p-6 md:p-8 border border-gray-100 rounded-3xl shadow-sm sticky top-6'>
                    <h3 className='font-bold text-[22px] text-gray-900 mb-6'>
                      Checkout
                    </h3>
                    {/* The PurchaseForm component acts as the entire checkout UI (methods, instructions, proof upload) */}
                    <PurchaseForm
                      pkg={selectedPackage}
        ...
        {showMedicalWarning && (
          <div className='fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-[2px]'>
            <motion.div
              ...
              className='bg-white w-full max-w-md rounded-[28px] shadow-2xl p-8 text-center relative overflow-hidden'>
              ...
              <div className='relative z-10 flex flex-col gap-3'>
                <button
                  ...
                  className='w-full py-3.5 bg-[#1D3D36] text-white font-bold rounded-xl hover:bg-[#0F2922] shadow-lg shadow-[#1D3D36]/20 transition-all active:scale-[0.98]'>
                  Complete Medical Profile
                </button>
                <button
                  onClick={() => setShowMedicalWarning(false)}
                  className='w-full py-3.5 bg-gray-50 text-gray-600 font-bold rounded-xl hover:bg-gray-100 transition-colors'>
                  Maybe Later
                </button>
              </div>
            </motion.div>
